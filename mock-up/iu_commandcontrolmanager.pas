...
begin
  ...
  for i:= 1 to 3 do begin
    if i = _id then begin
      V_IU_CommandsImages[i].CommandBouton:=V_IU_CommandsImages[i].CommandRem[2];
      V_IU_CommandsImages[i].CommandRem[4] := V_IU_CommandsImages[i].CommandBouton;
    end else begin
        V_IU_CommandsImages[i].CommandBouton:=V_IU_CommandsImages[i].CommandRem[3];
        V_IU_CommandsImages[i].CommandRem[4]:=V_IU_CommandsImages[i].CommandRem[3];
    end;
  end;
end;
