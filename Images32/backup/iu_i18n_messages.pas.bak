...
begin
  ...
  // ***
  // * Add v0.8
  IU_HI_Messages[K_IU_I18N_FRENCH,K_IU_HIMSG_Size] := 'Taille';
  IU_HI_Messages[K_IU_I18N_ENGLISH,K_IU_HIMSG_Size] := 'Size';

  IU_HI_Messages[K_IU_I18N_FRENCH,K_IU_HIMSG_Free] := 'Libre';
  IU_HI_Messages[K_IU_I18N_ENGLISH,K_IU_HIMSG_Free] := 'Free';
  // *
  // * End Add v0.8
  // ***
