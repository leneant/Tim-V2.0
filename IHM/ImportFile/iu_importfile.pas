...
begin
  if fontColorInverted then
    listFontColor := rgbtocolor(255-V_IU_Box_TextColorHigh.red, 255-V_IU_Box_TextColorHigh.green, 255-V_IU_Box_TextColorHigh.blue)
  else
    listFontColor := rgbtocolor(V_IU_Box_TextColorHigh.red, V_IU_Box_TextColorHigh.green, V_IU_Box_TextColorHigh.blue);
  ...
  with ImportFile do begin
    ...
    Button7.Color:=rgbtocolor(V_IU_Button_unfocused.red, V_IU_Button_unfocused.green, V_IU_Button_unfocused.blue);
    ...
    ListBox1.Font.Color:=listFontColor;
    ...
    ListBox2.Font.Color:=listFontColor;
...
begin
  ...
  // ***
  // * Add v0.5
  Button7.Caption := IU_HI_Messages[IU_CurrentLang,K_IU_HIMSG_ListInvFontColor];
  // ***
end;
...
begin
  ...
  button7.Left := ImportFile.Width - Button7.Width -5;
  if Button7.Left < Button6.Left+Button6.Width + 2 then Button7.Left := Button6.Left+Button6.Width + 2
end;
