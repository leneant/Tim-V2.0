...
begin
  ...
  with ImportFile do begin
    ...
    with WindowsColors do begin
      ...
      // ***
      // * Add v0.8
      Label12.Color:=WindowsColor;
      Label12.Font.Color:=TextColor;
      Label13.Color:=WindowsColor;
      Label13.Font.Color:=TextColor;
      Label14.Color:=WindowsColor;
      Label14.Font.Color:=TextColor;
      Label15.Color:=WindowsColor;
      Label15.Font.Color:=TextColor;
      Label16.Color:=WindowsColor;
      Label16.Font.Color:=TextColor;
      Label17.Color:=WindowsColor;
      Label17.Font.Color:=TextColor;
      Label18.Color:=WindowsColor;
      Label18.Font.Color:=TextColor;
      Label19.Color:=WindowsColor;
      Label19.Font.Color:=TextColor;
      Label20.Color:=WindowsColor;
      Label20.Font.Color:=TextColor;
      Label21.Color:=WindowsColor;
      Label21.Font.Color:=TextColor;
      Label22.Color:=WindowsColor;
      Label22.Font.Color:=TextColor;
      // *
      // * End Add v0.8
      // ***
...
begin
  // ***
  // * Add v0.8
  ImportFile.firstwarning := false;
  ImportFile.Label9.Caption := '';
  ImportFile.Label10.Caption:='';
  ImportFile.Label12.Caption:='';
  ImportFile.Label13.Caption:='';
  ImportFile.Label14.Caption:='';
  ImportFile.Label15.Caption:='';
  ImportFile.Label16.Caption:='';
  ImportFile.Label17.Caption:='';
  ImportFile.Label18.Caption:='';
  ImportFile.Label19.Caption:='';
  ImportFile.Label20.Caption:='';
  ImportFile.Label21.Caption:='';
  ImportFile.Label22.Caption:='';
  // * End Add v0.8
  // ***
  // * Add v0.6
...
begin
  ...
  if (ListBox2.Count > 0) and (ListBox2.ItemIndex > -1) then begin
    ...
    if not _error then begin
      ...
      Except
        if not ImportFile.firstwarning then begin
          ImportFile.firstwarning := true;
          MessageDlg(IU_ExceptionsMessages[IU_CurrentLang, K_IU_ExceptMSG_ExecError],
                     IU_HI_Messages[IU_CurrentLang,K_IU_HIMSG_WarningBoxTitle],
                     mtWarning, [mbOK],'');
        end;
      end;
      // *
